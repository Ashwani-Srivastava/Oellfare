        ...
        return (
            <ion-app>
                <ion-router useHash={false}>
                    ...
                    <ion-route url="/" component="clab-home" />
                    <ion-route url="/about" component="clab-about" />
                    <ion-route url="/about/press-coverage" component="clab-press-coverage" />
                    <ion-route url="/about/legal" component="clab-legal" />
                    <ion-route url="/contact" component="clab-contact" />
                    <ion-route url="/donate" component="clab-donate" />
                    <ion-route url="/projects" component="clab-projects" />
                    <ion-route url="/projects/:projectSlug" component="clab-projects-detail" />
                    <ion-route url="/volunteer" component="clab-volunteer" />
