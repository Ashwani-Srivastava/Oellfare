...
export class BoloBase {


    public static setupEssentials(snow: boolean = false) {
        ...
        BoloBase.filter_gallery();
        BoloBase.setupHeader();
        BoloBase.setupStickyHeader();
        BoloBase.nativeInit();

        BoloBase.setupRemaining();
    }


    public static filter_gallery() {
    ...
    public static setupStickyHeader() {
    ...
    public static nativeInit() {
        ...
        function scrolling() {
            ...
            if (mq.matches) {
                ...
                var distanceY = jQuery('#wrapper').scrollTop(),
                    shrinkOn = 0,
    ...
    public static setupMagnificPopup() {
    ...
    public static setupVideoAutosize() {
    ...
    public static initDe() {
        ...
        var preloader_pos = parseInt(jQuery(window).innerHeight()/2 as any)-30;
        $(".preloader1").css("top",preloader_pos);
    }

    public static setupRemaining() {
        /* --------------------------------------------------
         * plugin | owl carousel
         * --------------------------------------------------*/
        function load_owl() {
        ...
        $.scrollTo = $.fn.scrollTo = function(x, y, options){
            ...
            if (!(this instanceof $)) return $.fn.scrollTo.apply($('#wrapper'), arguments);
        ...
        */
        ...
        BoloBase.setupMagnificPopup();
        center_xy();
        BoloBase.initDe();
        BoloBase.handleResize();

        // https://stackoverflow.com/questions/56283383/using-wow-js-inside-a-scrollable-div
        let wow = new WOW({
        ...
        jQuery('#wrapper').on("scroll", function() {
            ...
            jQuery('#mainmenu li a').each(function () {
                ...
                if (this.href.indexOf('#') != -1) {
                    ...
                    //console.log(href + ' - offset : ' + jQuery(href).offset().top + '; ' + jQuery(window).height());
                    //if (jQuery('#wrapper').scrollTop() > jQuery(href).offset().top - 140) {
                    if (jQuery(window).height() > jQuery(href).offset().top - 140) {
                        jQuery('#mainmenu li a').removeClass('active');
                        jQuery(this).addClass('active');
                        //console.log(href + ' is now active');
                    }
                }
            });
        });
        ...
        if(smoothscroll==1){
            ...
            // scroll
            jQuery.easing.default = function (_x,t,b,c,d) {
