        ...
        return (
            <ion-app>
                <ion-router useHash={false}>
                    ...
                    <ion-route url="/" component="oellfare-home" />
                    <ion-route url="/about" component="oellfare-about" />
                    <ion-route url="/about/press-coverage" component="oellfare-press-coverage" />
                    <ion-route url="/about/legal" component="oellfare-legal" />
                    <ion-route url="/contact" component="oellfare-contact" />
                    <ion-route url="/donate" component="oellfare-donate" />
                    <ion-route url="/projects" component="oellfare-projects" />
                    <ion-route url="/projects/:projectSlug" component="oellfare-projects-detail" />
                    <ion-route url="/volunteer" component="oellfare-volunteer" />
