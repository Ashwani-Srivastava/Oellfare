        ...
        return (
            <ion-app>
                <ion-router useHash={false}>
                    ...
                    <ion-route url="/" component="verso-home" />
                    <ion-route url="/about" component="verso-about" />
                    <ion-route url="/about/press-coverage" component="verso-press-coverage" />
                    <ion-route url="/about/legal" component="verso-legal" />
                    <ion-route url="/contact" component="verso-contact" />
                    <ion-route url="/donate" component="verso-donate" />
                    <ion-route url="/projects" component="verso-projects" />
                    <ion-route url="/projects/:projectSlug" component="verso-projects-detail" />
                    <ion-route url="/volunteer" component="verso-volunteer" />
